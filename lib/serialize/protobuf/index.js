...
let decoder = null;
const mapType = {'java.lang.String':'StringValue', 'java.util.HashMap':'HashMap', 'java.util.ArrayList':'ArrayValue', 'java.lang.Exception':'AnyVal', 'boolean':'BoolValue', 'int':'Int32Value', 'long':'Int64Value', 'double':'DoubleValue'};
      ...
      if (v && v['$class'] && v['$'] && opts.proto) {
        ...
        if (Msg){
          ...
          switch (type) {
            ...
            case 'AnyVal':
            default:
              if (v.constructor && v.constructor.encode) bytes = v.constructor.encode(v).finish();
