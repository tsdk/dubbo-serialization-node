...
const {HESSIAN2_SERIALIZATION_ID, PROTOBUF_JSON_SERIALIZATION_ID, PROTOBUF_SERIALIZATION_ID} = require('./const');
...
const nameToSerializations = {
  ...
  "protobuf-json": require('./protobuf-json'), //todo not support
